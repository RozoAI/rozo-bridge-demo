...
Your wallet provider (MetaMask, WalletConnect, Ledger, etc.) has its own privacy policy. We do not control and are not responsible for the data practices of wallet providers.
