      ...
      {isExpanded && (
        <div className="grid grid-cols-6 items-center gap-2 flex-wrap animate-in slide-in-from-top-2 duration-200">
          ...
          >
            ...
            <span className="font-medium text-xs sm:text-md">Twitter</span>
          </a>
          <a
          ...
          >
            ...
            <span className="font-medium text-xs sm:text-md">Discord</span>
          </a>
          <a
          ...
          >
            ...
            <span className="font-medium text-xs sm:text-md">WhatsApp</span>
          </a>
          <a
          ...
          >
            ...
            <span className="font-medium text-xs sm:text-md">Telegram</span>
          </a>
          <button
            type="button"
