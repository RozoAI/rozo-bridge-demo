...
const getChainLogo = (chainId: number): string => {
  switch (chainId) {
    ...
    case base.id:
      return "/logos/base.png"; // Base
    case arbitrum.id:
      return "/logos/arbitrum.png"; // Arbitrum
    case optimism.id:
      return "/logos/op.png"; // OP Mainnet
    case polygon.id:
      return "/logos/polygon.png"; // Polygon
    case bsc.id:
      return "/logos/bnbchain.png"; // BNB Smart Chain
    case sepolia.id:
      return "/logos/ethereum.png"; // Sepolia (use Ethereum logo)
    case polygonMumbai.id:
      return "/logos/polygon.png"; // Mumbai (use Polygon logo)
    case solanaMainnet.id:
      return "/logos/solana.png"; // Solana (no logo provided, use globe)
...
export const getRpcUrl = (chainId: number): string => {
  const envKey = (() => {
    switch (chainId) {
      case mainnet.id:
        return "NEXT_PUBLIC_ETHEREUM_RPC_URL";
      case sepolia.id:
        return "NEXT_PUBLIC_SEPOLIA_RPC_URL";
      case base.id:
        return "NEXT_PUBLIC_BASE_RPC_URL";
      case arbitrum.id:
        return "NEXT_PUBLIC_ARBITRUM_RPC_URL";
      case optimism.id:
        return "NEXT_PUBLIC_OPTIMISM_RPC_URL";
      case polygon.id:
        return "NEXT_PUBLIC_POLYGON_RPC_URL";
      case bsc.id:
        return "NEXT_PUBLIC_BSC_RPC_URL";
      case polygonMumbai.id:
        return "NEXT_PUBLIC_MUMBAI_RPC_URL";
      default:
        return null;
    }
  })();
